...
public class ThirdTrimester {
    ...
    public ThirdTrimester(List<String> redCode, List<String> yellowCode, List<String> greenCode, List<String> whiteCode, String medicalPersonnelId, Date createdDate) {
