...
public class BreastFeedingActivity extends AppCompatActivity {
    ...
    {
        AlarmManager alarmManager = (AlarmManager)BreastFeedingActivity.this.getSystemService(Context.ALARM_SERVICE );
        Intent intent = new Intent(BreastFeedingActivity.this, NotifyService.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(BreastFeedingActivity.this, 9000, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        alarmManager.cancel(pendingIntent);
        pendingIntent.cancel();

        Intent intentReminder = new Intent(BreastFeedingActivity.this, ReminderService.class);
        PendingIntent pendingIntentReminder = PendingIntent.getBroadcast(BreastFeedingActivity.this, 101, intentReminder, PendingIntent.FLAG_UPDATE_CURRENT);
        alarmManager.cancel(pendingIntentReminder);
        pendingIntentReminder.cancel();

        Intent intentAlert = new Intent(BreastFeedingActivity.this, AlertService.class);
        PendingIntent pendingIntentAlert = PendingIntent.getBroadcast(BreastFeedingActivity.this, 1000, intentAlert, 0);
