...
public class UnusualCircumtancesActivity extends AppCompatActivity {
    ...
    {
        AlarmManager alarmManager = (AlarmManager)UnusualCircumtancesActivity.this.getSystemService(Context.ALARM_SERVICE );
        Intent intent = new Intent(UnusualCircumtancesActivity.this, NotifyService.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(UnusualCircumtancesActivity.this, 9000, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        alarmManager.cancel(pendingIntent);
        pendingIntent.cancel();

        Intent intentReminder = new Intent(UnusualCircumtancesActivity.this, ReminderService.class);
        PendingIntent pendingIntentReminder = PendingIntent.getBroadcast(UnusualCircumtancesActivity.this, 101, intentReminder, PendingIntent.FLAG_UPDATE_CURRENT);
        alarmManager.cancel(pendingIntentReminder);
        pendingIntentReminder.cancel();

        Intent intentAlert = new Intent(UnusualCircumtancesActivity.this, AlertService.class);
        PendingIntent pendingIntentAlert = PendingIntent.getBroadcast(UnusualCircumtancesActivity.this, 1000, intentAlert, 0);
            ...
            case R.id.action_logout:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        SaveSharedPreference.clearUser(UnusualCircumtancesActivity.this);
                        Intent intent = new Intent(UnusualCircumtancesActivity.this, MainActivity.class);
